      ...
      <div className={styles.desc}>
        {!isMobile ? (
          <AppearTitle key="desktop-overview">
            <h6 className="h6">
              Hey there! I&apos;m a 23-year-old seo specialist and full stack
              engineer from Bangladesh with a{' '}
            </h6>
            <h6 className="h6">
              passion for crafting amazing digital experiences. I studied
              software
            </h6>
            <h6 className="h6">
              engineering to deepen my understanding of how to build sleek
              and{' '}
            </h6>
            <h6 className="h6">efficient websites and apps.</h6>
            <h6 className={clsx(styles.paddingTop, 'h6')}>
              When I&apos;m not busy coding, you&apos;ll often find me soaking
              up inspiration from
            </h6>
            <h6 className="h6">
              the world of design. Whether it&apos;s exploring new color
              palettes or refining
            </h6>
            <h6 className="h6">
              user interfaces, I love bringing creativity into my work.
            </h6>
            <h6 className={clsx(styles.paddingTop, 'h6')}>
              When I&apos;m not immersed in coding, I enjoy staying active. I
              love swimming,{' '}
            </h6>
            <h6 className="h6">
              rowing, and playing intense PC games to relax and recharge.
            </h6>

            <h6 className={clsx(styles.paddingTop, 'h6')}>
              I&apos;m looking forward to collaborating and creating something
              great!
            </h6>
          ...
          <AppearTitle key="mobile-overview">
            ...
            <h6 className="h6">
              with a passion for crafting amazing digital experiences. I
              studied{' '}
            </h6>
            <h6 className="h6">
              software engineering to deepen my understanding of how to{' '}
            </h6>
            ...
            <h6 className="h6">
              inspiration from the world of design. Whether it&apos;s exploring
              new
            </h6>
            <h6 className="h6">
              color palettes or refining user interfaces, I love bringing
            </h6>
            ...
            <h6 className="h6">
              swimming, rowing, and playing intense PC games to relax
            </h6>
