...
const containt = [
  {
    ...
    desc: [
      <div className="p-l">
        {' '}
        With a focus on innovation and efficiency, I build robust solutions that
        meet your
      </div>,
      <div className="p-l">
        {' '}
        business objectives. From frontend to backend, I leverage
        cutting-edge{' '}
      </div>,
      <div className="p-l">
        technologies to deliver scalable and sustainable software.
      </div>,
    ],
    descMobile: [
      <div className="p-l">
      ...
      <div className="p-l">
        meet your business objectives. From frontend to backend, I leverage{' '}
      </div>,
      <div className="p-l">
        cutting-edge technologies to deliver scalable and sustainable
      </div>,
  ...
  },
  {
    ...
    desc: [
      <div className="p-l">
        I use advanced methods to make your website more visible online, attract
        more
      </div>,
      <div className="p-l">
        visitors naturally, and rank higher in search engines. From improving
        your website&apos;s
      </div>,
      <div className="p-l">
        content to building quality links, I make sure your site performs its
        best.
      </div>,
    ],
    descMobile: [
      <div className="p-l">
        I use advanced methods to make your website more visible online,
      </div>,
      <div className="p-l">
        attract more visitors naturally, and rank higher in search engines.
      </div>,
      <div className="p-l">
        From improving your website&apos;s content to building quality links, I
        make
      </div>,
  ...
  },
  {
    ...
    desc: [
      <div className="p-l">
        I create engaging and effective digital interfaces that enhance the user
        experience.
      </div>,
      <div className="p-l">
        From understanding user needs to crafting intuitive layouts and visuals,
        I verify your
      </div>,
      <div className="p-l">
        application is both functional and aesthetically pleasing. My services
        include{' '}
      </div>,
      <div className="p-l">
        everything from user research to interactive design, helping you achieve
        a seamless{' '}
      </div>,
    ...
    descMobile: [
      <div className="p-l">
        I create engaging and effective digital interfaces that enhance the
      </div>,
      <div className="p-l">
        user experience. From understanding user needs to crafting intuitive
      </div>,
      <div className="p-l">
        layouts and visuals, I verify your application is both functional and
      </div>,
      <div className="p-l">
        esthetically pleasing. My services include everything from user
      </div>,
      <div className="p-l">
        a research to interactive design, helping you achieve a seamless and
      </div>,
